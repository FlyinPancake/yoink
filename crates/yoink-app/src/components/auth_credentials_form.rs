...
const CARD: &str = "w-full max-w-md rounded-2xl border border-black/[.08] dark:border-white/[.08] bg-white/78 dark:bg-zinc-900/72 backdrop-blur-[20px] shadow-[0_20px_80px_rgba(15,23,42,.12)] dark:shadow-[0_24px_90px_rgba(0,0,0,.45)] overflow-hidden";
